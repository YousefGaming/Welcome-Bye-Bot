...
client.on("guildMemberAdd", member => {
        if(member.guild.id === "513019757746847754") {  // 437964440529272835
  const channel = member.guild.channels.find('id', '514055972294098945'); //514481507688251415
if (!channel) return;
channel.send(`**<@${member.user.id}> Welcome To __ArabKings Server__  ** ❤️ `)  
}});
client.on("guildMemberRemove", member => {
        if(member.guild.id === "513019757746847754") { 
  const channel = member.guild.channels.find('id', '514055972294098945'); 
if (!channel) return;
  channel.send(`**${member.user.tag} مع سلامه صديقي  ** 😭 `) 
}});
client.on('guildMemberAdd', member=> {
